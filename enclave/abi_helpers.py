...
Shared utility functions for ABI encoding / decoding used by both
kms_registry.py and nova_registry.py.

Low fix: eliminates duplicate ABI helper code across registry wrappers.
"""
