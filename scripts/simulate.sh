...
SIMULATION_MODE=1 SIM_PORT=4000 SIM_NODE_INDEX=0 $PYTHON_CMD enclave/app.py > logs/node0.log 2>&1 &

# Start Node 1
echo "Starting Node 1 on port 4001..."
SIMULATION_MODE=1 SIM_PORT=4001 SIM_NODE_INDEX=1 $PYTHON_CMD enclave/app.py > logs/node1.log 2>&1 &

# Start Node 2
echo "Starting Node 2 on port 4002..."
SIMULATION_MODE=1 SIM_PORT=4002 SIM_NODE_INDEX=2 $PYTHON_CMD enclave/app.py > logs/node2.log 2>&1 &
